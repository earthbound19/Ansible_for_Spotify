...
# Pass the playlist to this script via clipboard or file (see USAGE), and it will
# give you back the elements in the list arranged with N "tent poles" of highest valence
...
#      python3 /path/to/tent_pole_sort_for_ansible_for_spotify.py
...
#      python3 /path/to/tent_pole_sort_for_ansible_for_spotify.py -n 7
...
#      python3 /path/to/tent_pole_sort_for_ansible_for_spotify.py -i future_bass.txt
#      -> output: saves to 'future_bass_tentpole_sorted_5.txt'.
#
#   4. file input ('future_bass.txt'), N = 7, with verbose logging:
#      python3 /path/to/tent_pole_sort_for_ansible_for_spotify.py -i future_bass.txt -n 7 -v
